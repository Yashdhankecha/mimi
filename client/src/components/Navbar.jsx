        ...
        <div className="hidden md:flex items-center gap-8">
          {navLinks.map((link) => (
            <Link
              ...
              to={link.href}
              className={cn(
                "font-heading font-bold text-gray-600 hover:text-mimi-blue transition-colors text-lg relative after:content-[''] after:absolute after:left-0 after:bottom-[-4px] after:w-0 after:h-1 after:bg-mimi-yellow after:rounded-full after:transition-all hover:after:w-full",
                location.pathname === link.href && "text-mimi-blue after:w-full"
              )}
            >
              {link.name}
            </Link>
